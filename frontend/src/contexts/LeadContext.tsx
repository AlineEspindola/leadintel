...
export function LeadProvider({ children }: { children: ReactNode }) {
  const [currentLead, setCurrentLead] = useState<CompanyResponseDTO | null>(null)
  return <LeadContext.Provider value={{ currentLead, setCurrentLead }}>{children}</LeadContext.Provider>
}
