...
> = {
  invalid_cnpj: {
    ...
    description:
      "Verifique se os 14 dígitos estão corretos ou tente outro CNPJ.",
    action: "Limpar e tentar novamente",
  },
  api_failure: {
    icon: "🔌",
  ...
  inactive_company: {
    ...
    description:
      "Este CNPJ pertence a uma empresa encerrada ou com situação irregular na Receita Federal.",
