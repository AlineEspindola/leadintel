  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "data-lg": [
          "0.9375rem",
          { lineHeight: "1.4", fontFamily: "IBM Plex Mono" },
        ],
        // Headings
        ...
        display: [
          "2rem",
          { lineHeight: "1.1", fontFamily: "DM Serif Display" },
        ],
        "display-lg": [
          "2.5rem",
          { lineHeight: "1.1", fontFamily: "DM Serif Display" },
      ...
      boxShadow: {
        ...
        "glow-hot":
          "0 0 20px rgba(245,82,26,0.30), 0 0 40px rgba(245,82,26,0.15)",
        "glow-warm":
          "0 0 20px rgba(245,166,35,0.25), 0 0 40px rgba(245,166,35,0.12)",
        "glow-primary":
          "0 0 20px rgba(47,111,237,0.30), 0 0 40px rgba(47,111,237,0.15)",
  ...
  plugins: [
    ...
    function ({
      ...
      addUtilities({
        ".skeleton": {
          background:
            "linear-gradient(90deg, #1E2737 25%, #2A3548 50%, #1E2737 75%)",
